...
public class ActivePlanActivity  extends AppCompatActivity {
    ...
    private AdapterView.OnItemLongClickListener mItemLongClickListener = new AdapterView.OnItemLongClickListener() {
        ...
        public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            PopupMenu popup = new PopupMenu(ActivePlanActivity.this, view);
                ...
                public boolean onMenuItemClick(MenuItem item) {
                    switch (item.getItemId()) {
                        ...
                        case R.id.change:
                            ...
                            AlertDialog.Builder alert = new AlertDialog.Builder(ActivePlanActivity.this);

                            alert.setTitle("이름바꾸기");
                            alert.setMessage("새 이름을 입력해주세요");

                            final EditText input = new EditText(ActivePlanActivity.this);
                            alert.setView(input);
